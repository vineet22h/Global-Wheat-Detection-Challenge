...
def show_img(img, bboxes, scores, add_scores = False, save = False, img_name = 'saved_img.jpeg'):
    ...
    for i in range(len(bboxes)):
        ...
        if add_scores:
            rect2 = patches.Rectangle(
                ...
                facecolor = 'red')
            ax.add_patch(rect2)
            ax.text(bboxes[i][0], bboxes[i][1], round(scores[i], 3), fontsize = 6, fontdict = {'color': 'black', 'weight':'bold'})
    print('figure annoted')
    ax.imshow(img)
    if save:
        print('figure saved')
